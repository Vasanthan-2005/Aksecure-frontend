      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-slate-900/40 rounded-2xl p-4 border border-white/5 hover:border-violet-500/20 hover:bg-slate-900/60 transition-all group shadow-lg">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs text-slate-500 font-bold uppercase tracking-tight group-hover:text-violet-400 transition-colors">Name</span>
          </div>
          <p className="font-black text-slate-100 text-sm tracking-tight group-hover:text-white transition-colors">{userData.name}</p>
        </div>
        <div className="bg-slate-900/40 rounded-2xl p-4 border border-white/5 hover:border-violet-500/20 hover:bg-slate-900/60 transition-all group shadow-lg">
          <div className="flex items-center gap-2 mb-2">
