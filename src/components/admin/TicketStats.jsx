...
const StatItem = ({ label, count, color, Icon, total, showPercentage = true, showIcon = true, delay = "0.1s" }) => {
  ...
  return (
    <div
      className={`group relative overflow-hidden rounded-2xl border ${color.border} bg-slate-950/40 p-4 backdrop-blur-xl h-18 ${color.glowShadow}`}
    >
      {/* Dynamic Glow Aura */}
...
const TicketStats = ({ stats, showPercentage = true, showIcon = true }) => {
  return (
